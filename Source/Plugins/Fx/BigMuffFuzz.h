    ...
    public:
              ...
              bypassParameter(bypassParam)
        {
            ...
            for (auto* l : { &sustainLabel, &toneLabel, &volumeLabel })
            {
                ...
                // Kontrast verbessern: Labels über dem weißen Feld schwarz statt weiß
        ...
        void resized() override
        {
            ...
            // Knobs vertikal mittig in der weißen Box platzieren
            ...
            // Labels innerhalb der weißen Box (konstanter Abstand)
